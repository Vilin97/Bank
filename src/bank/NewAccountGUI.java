...
public class NewAccountGUI extends javax.swing.JFrame {
    ...
    private void initActionListeners(Customer user, CustomerGUI maingui){
        ...
        createChekAccjButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                createAcct(user, maingui, this , 0);//checking acc is 0, sav acc is 1
            }
        ...
        createSavAccjButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                createAcct(user, maingui, this, 1);
            }
    ...
    public void createAcct(Customer user, CustomerGUI maingui, NewAccountGUI newaccgui, int type){
        jPanel1.setVisible(false);
        JPanel temp = new NewAccountFormGUI(user,maingui,newaccgui,type);
        this.add(temp);
    }
    /**
